...
describe DisplaysController do
  ...
  # DisplaysController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all displays as @displays" do
      ...
      assigns(:displays).should eq([display])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved display as @display" do
        ...
        post :create, {:display => { "name" => "invalid value" }}, valid_session
        assigns(:display).should be_a_new(Display)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested display" do
        ...
        Display.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => display.to_param, :display => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the display as @display" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Display.any_instance.stub(:save).and_return(false)
        put :update, {:id => display.to_param, :display => { "name" => "invalid value" }}, valid_session
        assigns(:display).should eq(display)
      end
